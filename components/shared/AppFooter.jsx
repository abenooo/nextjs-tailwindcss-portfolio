...
const socialLinks = [
	
	{
		id: 2,
		icon: <FiGithub />,
		url: 'https://github.com/abenooo',
	},
	{
		id: 3,
		icon: <FiTwitter />,
		url: 'https://twitter.com/kifle_abenezer',
	},
	{
		id: 4,
		icon: <FiLinkedin />,
		url: 'https://www.linkedin.com/in/abenezer-kifle-2490271a3/',
	},
	{
		id: 5,
		icon: <FiYoutube />,
		url: 'https://www.youtube.com/@CodeXEthiopia',
	},
];
